...
class Covid_19():
    ...
    def __init__(self):
        ...
        self.driver = webdriver.Chrome('/Users/arsalan/Documents/chromedriver')

        def get_data(self):

        Country = "Pakistan" # Change to Desired
...
corona_bot.driver.get('https://www.worldometers.info/coronavirus/')